...
?>					
		                    <div class="row">
		                        <div class="col-sm-2">
		                            <h5>Title:</h5>
		                            <form  method="Post">
		                            <b> <input type="text" class="form-control" name="<?php echo $row3[0]."title";?>" id="<?php echo $row3[0]."title";?>"  value="<?php echo ($row3[1]);?>"></input> </b>
